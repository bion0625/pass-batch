...
class AddPassesTaskletTest {
    ...
    public void test_execute() throws Exception {
        ...
        bulkPassEntity.setEndedAt(now.minusDays(60));
        ...
        ArgumentCaptor<List> passEnArgumentCaptor = ArgumentCaptor.forClass(List.class);
        verify(passRepository, times(1)).saveAll(passEnArgumentCaptor.capture());
        final List<PassEntity> passEntities = passEnArgumentCaptor.getValue();
