...
public class SendNotificationItemWriter implements ItemWriter<NotificationEntity> {
    ...
    private final KakaoTalkMessageAdapter kaKaoMessageAdapter;

    public SendNotificationItemWriter(NotificationRepository notificationRepository, KakaoTalkMessageAdapter kaKaoMessageAdapter) {
    ...
    public void write(List<? extends NotificationEntity> notificationEntities) throws Exception {
        ...
        for (NotificationEntity notificationEntity : notificationEntities) {
            boolean successful = kaKaoMessageAdapter.sendKakaoTalkMessage(notificationEntity.getUuid(), notificationEntity.getText());
